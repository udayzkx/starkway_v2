...
mod test_utils {
    ...
    fn test_sort_token_amounts() {
        ...
        data
            .append(
                TokenAmount {
                    l1_address: l1_address_1, l2_address: user_1, amount: u256 { low: 100, high: 0 }
                }
            );
        ...
        data
            .append(
                TokenAmount {
                    l1_address: l1_address_2, l2_address: user_1, amount: u256 { low: 300, high: 0 }
                }
            );
        data
            .append(
                TokenAmount {
                    l1_address: l1_address_2, l2_address: user_2, amount: u256 { low: 200, high: 0 }
                }
            );
        data
            .append(
                TokenAmount {
                    l1_address: l1_address_2, l2_address: user_3, amount: u256 { low: 100, high: 0 }
                }
            );
        ...
        correct
            .append(
                TokenAmount {
                    l1_address: l1_address_2, l2_address: user_1, amount: u256 { low: 100, high: 0 }
                }
            );
        correct
            .append(
                TokenAmount {
                    l1_address: l1_address_2, l2_address: user_1, amount: u256 { low: 200, high: 0 }
                }
            );
        correct
            .append(
    ...
    fn test_reverse_array() {
        ...
        let mut reversed = reverse(@data);

        assert(is_equal(@reversed, @correct) == true, 'invalid result 1');
    }

    fn is_equal<T, impl TCopy: Copy<T>, impl TDrop: Drop<T>, impl TPartialEq: PartialEq<T>>(
        a: @Array<T>, b: @Array<T>
    ) -> bool {
        let len = a.len();
        if len != b.len() {
